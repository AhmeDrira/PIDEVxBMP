...
const { checkSlugEditable, SLUG_ERRORS } = require('../utils/slugRules');
...
exports.checkSlug = async (req, res) => {
  try {
    ...
    // déclenché à chaque frappe (debounce 500 ms), un 4xx polluerait la console
    // du navigateur à chaque caractère intermédiaire.
...
exports.SLUG_ERRORS = SLUG_ERRORS;
