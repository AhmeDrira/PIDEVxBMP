 ...
 *
 *   hamza-electricien-tunis.mestra.tn/  → mini site de Hamza
...
// l'API, les médias du portfolio, et la route d'avatar utilisée par og:image.
const PASSTHROUGH_PREFIXES = ['/api', '/uploads', '/site'];
