                      ...
                      return (
                        <div key={i} className="flex gap-4">
                          <div className="flex flex-col items-center">
                            <div className={`w-8 h-8 rounded-full flex items-center justify-center ${eventConf.bg || 'bg-gray-100'} border`}>
                              <EventIcon size={14} className={eventConf.color || 'text-gray-500'} />
                            </div>
              ...
              <div className="lg:col-span-2">
                <Card className="p-6 bg-white rounded-2xl border-0 shadow-lg">
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-100 space-y-2">
                    ...
                    <div className="flex justify-between font-bold text-foreground pt-2 border-t border-gray-100">
                      <span>Total</span>
          ...
          {filtered.map((order) => {
            ...
            return (
              <Card
                ...
                className="bg-white rounded-2xl border-0 shadow-lg hover:shadow-xl transition-all cursor-pointer group"
